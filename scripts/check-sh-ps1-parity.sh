...
EXCEPTIONS=(
  ...
  "macos/prune_keyboard_shortcuts.sh:macOS専用（アプリケーションショートカット）"
  ...
  "npm/prune_npmfile.sh:TODO: dots.ps1がnpmサブコマンド未実装のため未移植"
  ...
  "pipx/prune_pipxfile.sh:TODO: dots.ps1がpipxサブコマンド未実装のため未移植"
