...
研究論文、学位論文、研究計画書、研究報告書などの科学的文書を `Deep` または `Deep-Auto` でレビューする際は、通常の論理・構成レビューに加え、読者が問い・根拠・方法・得られる結論の関係を追えるか確認する。著者の専門的判断を伴う問題は、本文を自動で書き換えず、具体的な改善方向を示すアンカーコメントにする。
